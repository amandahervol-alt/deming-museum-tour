...
# 2. Draw 'QUILT & LACE ROOM' (or 'QUILT/LACE ROOM')
...
x2, y2 = get_text_center(title_line2, font_title2, 290)
...
# 3. Generate QR code for Room 10
qr = qrcode.QRCode(
    version=1,
...
# Also save quilt_lace_room_poster_placard.jpg
