...
# 1. Configuration for Main Room (Room 3)
ROOM_ID = 3
...
# 3. White Lettering with dark drop shadow (Matching Transportation Annex & Other Placards)
font_title1 = ImageFont.truetype(r"C:\Windows\Fonts\georgiab.ttf", 44)
...
# 5. Save poster files
out_jpg = "qr_codes/main_room_poster_placard.jpg"
out_png = "qr_codes/main_room_poster_placard.png"
...
artifact_jpg = os.path.join(artifact_dir, "main_room_poster_placard.jpg")
...
print(f"Main Room Poster: Scannable? -> {bool(val)} | Decoded: '{val}'")
